...
fout.write('<a href="#elo_3">The Fastgame Rating (Best Versions Only)</a>\n')
fout.write('<a href="#elo_4">The Standard Rating (Best Versions Only)</a></strong>\n')
fout.write('\n')
fout.write('<a href="#elo_5">The General Rating (All Versions)</a>\n')
...
fout.write(fin.read())
fin.close()
fout.write('<a id="elo_2"></a>The Freestyle Rating:\n')
fin = open(sys.argv[2], 'r')
fout.write(fin.read())
fin.close()
fout.write('<a id="elo_3"></a>The Fastgame Rating:\n')
fin = open(sys.argv[3], 'r')
fout.write(fin.read())
fin.close()
fout.write('<a id="elo_4"></a>The Standard Rating:\n')
fin = open(sys.argv[4], 'r')
fout.write(fin.read())
fin.close()
fout.write('<a id="elo_5"></a>The Complete General Rating (Freestyle, Fastgame, Standard):\n')
fin = open(sys.argv[5], 'r')
fout.write(fin.read())
fin.close()
fout.write('<a id="elo_6"></a>The Complete Freestyle Rating:\n')
fin = open(sys.argv[6], 'r')
fout.write(fin.read())
fin.close()
fout.write('<a id="elo_7"></a>The Complete Fastgame Rating:\n')
